...
import static info.after_sunrise.commons.base.comparator.NullSafeComparator.get;
import static info.after_sunrise.commons.base.object.Validations.checkNotNull;
import info.after_sunrise.commons.base.comparator.NullSafeComparator;
...
public final class Conversions {
	...
	public static <K1, K2 extends Comparable<K2>, V> NavigableMap<K2, V> convertKeyNavigable(
		...
		NavigableMap<K2, V> values = new TreeMap<K2, V>(get());
	...
	public static <K extends Comparable<K>, V1, V2> NavigableMap<K, V2> convertValueNavigable(
		...
		NavigableMap<K, V2> values = new TreeMap<K, V2>(get());
